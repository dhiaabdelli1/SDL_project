...
{
	SDL_Rect pos;
	pos.x = E->position.x - b.position_background.x;
	pos.y = E->position.y - b.position_background.y;
...
{
	SDL_Rect pos;
	pos.x = p.position.x - b.position_background.x;
	pos.y = p.position.y - b.position_background.y;
