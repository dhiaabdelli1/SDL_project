...
void game_over(SDL_Surface *screen, etat *etat, parameter *p)
{
	...
	SDL_Surface *game_over_bg = IMG_Load("./img/menu/game_over.jpg");
	SDL_Rect position_game_over;
	position_game_over.x = 0;
	position_game_over.y = 0;

	SDL_Surface *main_menu = IMG_Load("./img/menu/main_menu.png");
	SDL_Rect position_main_menu;
	position_main_menu.x = 600;
	position_main_menu.y = 300;

	SDL_Surface *restart = IMG_Load("./img/menu/restart.png");
		...
		while (SDL_PollEvent(&event))
		{
			...
			case SDL_KEYDOWN:
				...
				case SDLK_RIGHT:
					...
					main_menu = IMG_Load("./img/menu/main_menu_active.png");
					restart = IMG_Load("./img/menu/restart.png");
					rang = 1;
					break;
				case SDLK_LEFT:
					//Mix_PlayChannel(-1, p->click, 0);

					restart = IMG_Load("./img/menu/restart_active.png");
					main_menu = IMG_Load("./img/menu/main_menu.png");
					rang = 0;
					break;
				case SDLK_RETURN:
					//Mix_PlayChannel(-1, p->click, 0);
...
void game_load(hero *h, background *b, etat *etat, SDL_Surface *screen, parameter *p, character *c)
{
	...
	SDL_Surface *character_choice = SDL_LoadBMP("./img/menu/ZEUUN.bmp");
	...
	SDL_Surface *cont = IMG_Load("./img/menu/continue.png");
	SDL_Rect positionPlay;
	positionPlay.x = 227;
	positionPlay.y = 219;

	SDL_Surface *new_game = IMG_Load("./img/menu/new_game.png");
	SDL_Rect positionSettings;
	positionSettings.x = 227;
	positionSettings.y = 264;

	SDL_Surface *back = IMG_Load("./img/menu/back.png");
	SDL_Rect pos_back;
	pos_back.x = 330;
	pos_back.y = 330;
	...
	while (continuer)
	{
		...
		{
		case 0:
			cont = IMG_Load("./img/menu/continue_active.png");
			new_game = IMG_Load("./img/menu/new_game.png");
			back = IMG_Load("./img/menu/back.png");
			break;
		case 1:
			new_game = IMG_Load("./img/menu/new_game_active.png");
			cont = IMG_Load("./img/menu/continue.png");
			back = IMG_Load("./img/menu/back.png");
			break;
		case 2:
...
void initialiser_parameters(parameter *p)
{
	...
	p->music = Mix_LoadMUS("./img/menu/game_menu_music.wav");
	p->click = Mix_LoadWAV("./img/menu/click.wav");
